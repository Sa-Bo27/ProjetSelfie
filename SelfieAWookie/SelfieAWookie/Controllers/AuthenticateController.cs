...
namespace SelfieAWookie.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("register")]
        public async Task<IActionResult> Register([FromBody] AuthenticationUserDTO dtoUser)
        {
            ...
            var sucess = await _userManager.CreateAsync(user);
        ...
        [HttpPost]
        public async Task<IActionResult> Login([FromBody] AuthenticationUserDTO dtoUser)
        {
            IActionResult result = this.BadRequest();
            ...
            if (user != null)
            {
                ...
                if (verif)
                {
                    result = this.Ok(new AuthenticationUserDTO()
                    {
                        Login = user.Email,
                        Name = user.UserName,
